...
cl = LINETCR.LINE()
#cl.login(qr=True) ini souma
cl.login(token='Eoa3sKCyZdFCMMz7yrTd.SB3VnlSeay5u8/Qr+Ptdpq.VsiRBVq2dMZX6upcmynPksGtjn0jiO72hwh19vzKwKo=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True) ini shun
ki.login(token='EoGLJNTFbnSQmck0Afz7.mhJ6EgBJ9pWxI8z6B0IvzW.B9OfJNePzbCBCQZQ/dqfLdlSmUAkdWiPoZVDoX33z+4=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True) ini satoshi
kk.login(token='EofxyTSI3WMlLUVaFXI1.mxHaZXd+oaBerZSkvGECKq.b5lHo/m7k9Ypuso1fm0xlctiZLwL9jutzGdnShz64P8=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True) ini erina
kc.login(token='EozhwrJx3FIVO2BzOLkf.SJpGYdQi7J1zCCjfdaPDFW./1W/1zKpcCKGvaZVDL5YdXOcn/AzKw7QQv0copyhZBM=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True) ini hayma
kr.login(token='Eo7ZdwEyXVpaAvCG9Lpf.cLGppn59Eu9b5KyFU+rLxW.iO/bBh5Kv2rkaxJT6oAhAZPsUSKtoq3i+HEu8ZzXBz0=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True) ini ryo
km.login(token='EoYdcW7eldIOMjg7wS77.ZRAYeTbEEOjY9gogBDKv1W.J0QL7zWRNe7UHTWrQ4IQPtxxzA31N2yamS12j97idOk=')
km.loginResult()
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Aldier Dihapus")
                        except:
                            pass
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus aldier")
